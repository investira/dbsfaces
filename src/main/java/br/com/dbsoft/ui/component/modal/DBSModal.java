...
@FacesComponent(DBSModal.COMPONENT_TYPE)
public class DBSModal extends DBSUIOutput implements NamingContainer{  

	public final static String COMPONENT_TYPE = DBSFaces.DOMAIN_UI_COMPONENT + "." + DBSFaces.ID.MODAL;
    ...
    public DBSModal(){
		setRendererType(DBSModal.RENDERER_TYPE);
    }

package br.com.dbsoft.ui.component.crudmodal;
 ...
 *
 */
@FacesComponent(DBSCrudModal.COMPONENT_TYPE)
public class DBSCrudModal extends DBSUIComponentBase implements NamingContainer, SystemEventListener { 

	public final static String COMPONENT_TYPE = DBSFaces.DOMAIN_UI_COMPONENT + "." + DBSFaces.ID.CRUDMODAL;
	public final static String RENDERER_TYPE = "/resources/component/crudModal.xhtml";
	...
	public DBSCrudModal(){
		setRendererType(DBSCrudModal.RENDERER_TYPE);

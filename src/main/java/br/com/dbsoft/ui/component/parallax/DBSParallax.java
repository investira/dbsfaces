...
@FacesComponent(DBSParallax.COMPONENT_TYPE)
public class DBSParallax extends DBSUIComponentBase {
	
	public final static String COMPONENT_TYPE = DBSFaces.DOMAIN_UI_COMPONENT + "." + DBSFaces.ID.PARALLAX;
    ...
    public DBSParallax(){
		setRendererType(DBSParallax.RENDERER_TYPE);
    }
